...
using System.Text;
using System.Data;
using Business.FlyWheel7Business;

namespace Facade.FlyWheel7Facade
{
    public class FlyWheel7Facade
    {
        public FlyWheel7Facade()
        {
        }
        ...
        {
            FlyWheel7Business business = new FlyWheel7Business();
