...
namespace Business.FlyWheel4Business
{
    public class FlyWheel4Business
    {
        ...
        public FlyWheel4Business()
        {
            try
            {
                ...
                //电机ID
                string AxisID = System.Configuration.ConfigurationSettings.AppSettings["Motor4AxisIDString"];
                string[] axisPara = AxisID.Split('=');
                axis_IDnumber = axisPara[1].Trim();
                Defs.Motor4ID = axis_IDnumber;
            }
            catch (Exception ex)
            {
            ...
            string RotorRevRea, string datetime, string experiment_name, string experiment_memeber, string experiment_product, string real_deta_moment)
        {
            ...
            string sql = "insert into dbo.Motor41(MotorID, Scheme, SouceVol, SouceCut, RotorVol, RotorCut, RotorPow, ConstantMoment, ChangeMoment, RotorRevIde, RotorRevRea, DateTime, backup1,backup2,backup3,backup4)";
    ...
    string RotorPow, string RotorRevRea, string MeanTorque, string datetime, string ideal_torque, string experiment_name, string experiment_memeber, string experiment_product)
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor42(MotorID, Scheme, SouceVol, SouceCut, RotorVol, RotorCut, RotorPow, RotorRevRea, MeanTorque, datetime,backup1,backup2,backup3,backup4)";
        ...
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor46(MotorID, Scheme, RotorCut,datetime,backup1,backup2,backup3)";
        ...
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor43(MotorID, Scheme, SouceVol, SouceCut, RotorVol, RotorCut, RotorPow, RotorRevIde, RotorRevRea, datetime, backup1,backup2,backup3,backup4,backup5,backup6,backup7,backup8)";
    ...
    string RotorPow, string RotorRevRea, string MeanTorque, string datetime, string ideal_torque, string experiment_name, string experiment_memeber, string experiment_product, string Scheme4_torque)
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor44(MotorID, Scheme, SouceVol, SouceCut, RotorVol, RotorCut, RotorPow, RotorRevRea, MeanTorque, datetime,backup1,backup2,backup3,backup4,backup5)";
        ...
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor45(MotorID, Scheme, TimeConstant, datetime,backup1,backup2,backup3)";
