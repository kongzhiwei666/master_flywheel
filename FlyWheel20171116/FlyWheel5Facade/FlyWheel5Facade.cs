...
using System.Text;
using System.Data;
using Business.FlyWheel5Business;

namespace Facade.FlyWheel5Facade
{
    public class FlyWheel5Facade
    {
        public FlyWheel5Facade()
        {
        }
        ...
        {
            FlyWheel5Business business = new FlyWheel5Business();
