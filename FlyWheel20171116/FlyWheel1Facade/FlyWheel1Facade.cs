...
using System.Text;
using System.Data;
using Business.FlyWheel1Business;

namespace Facade.FlyWheel1Facade
{
    public class FlyWheel1Facade
    {
        public FlyWheel1Facade()
        {
        }
        ...
        {
            FlyWheel1Business business = new FlyWheel1Business();
