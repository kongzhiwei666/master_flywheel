...
namespace Framework.WinGui.Controls
{
    ...
    public class NotifyIconAnimation : System.ComponentModel.Component
    {
        ...
        /// </summary>
        private class MessageHandler : System.Windows.Forms.Form
        {
            ...
            protected override void OnMouseUp(MouseEventArgs e) { if (MouseUpNotify != null) MouseUpNotify(this, e); }
            protected override void OnMouseDown(MouseEventArgs e) { if (MouseDownNotify != null) MouseDownNotify(this, e); }
            protected override void OnMouseMove(MouseEventArgs e) { if (MouseMoveNotify != null) MouseMoveNotify(this, e); }
            ...
            public MessageHandler()
            {
                ...
                Size = new Size(20, 20);
                DesktopLocation = new Point(-100, -100);	// do not show up on any extended desktop screen
                Show();
            }
                    ...
                    case WM_NOTIFYICONCALLBACK:
                        ...
                        switch ((int)m.LParam)
                        {
                            ...
                            case WM_MBUTTONDBLCLK:
                                OnDoubleClickNotify(new MouseEventArgs(MouseButtons, 0, MousePosition.X, MousePosition.Y, 0));
                                break;
                            case WM_LBUTTONDOWN:
                            case WM_RBUTTONDOWN:
                            case WM_MBUTTONDOWN:
                            ...
                            case WM_LBUTTONUP:
                                ...
                                OnClickNotify(new MouseEventArgs(MouseButtons.Left, 0, MousePosition.X, MousePosition.Y, 0));
                                break;
                            case WM_RBUTTONUP:
                                OnMouseUp(new MouseEventArgs(MouseButtons.Right, 0, MousePosition.X, MousePosition.Y, 0));
                                OnClickNotify(new MouseEventArgs(MouseButtons.Right, 0, MousePosition.X, MousePosition.Y, 0));
                                break;
                            case WM_MBUTTONUP:
                                OnMouseUp(new MouseEventArgs(MouseButtons.Middle, 0, MousePosition.X, MousePosition.Y, 0));
                                OnClickNotify(new MouseEventArgs(MouseButtons.Middle, 0, MousePosition.X, MousePosition.Y, 0));
                                break;
        ...
        [DescriptionAttribute("Occurs when the balloon disappears梖or example, when the icon is deleted. This message is not sent if the balloon is dismissed because of a timeout or a mouse click."),
        System.ComponentModel.CategoryAttribute("Behavior")]
        public event EventHandler BalloonHide;
        ...
        private void InitAniTimer()
        {
            ...
            ((System.ComponentModel.ISupportInitialize)(_aniStepTimer)).BeginInit();
            ...
            ((System.ComponentModel.ISupportInitialize)(_aniStepTimer)).EndInit();
        }
        ...
        protected virtual void OnClickDownCast(object o, MouseEventArgs e) { if (Click != null) Click(this, (EventArgs)e); }
        protected virtual void OnDoubleClickDownCast(object o, MouseEventArgs e) { if (DoubleClick != null) DoubleClick(this, (EventArgs)e); }
