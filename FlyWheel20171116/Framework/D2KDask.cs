...
namespace Framework
{
    ...
    public class D2KDASK
    {
        ...
        ** PCIS-DASK Function prototype
        ...
        [DllImport("D2K-Dask.dll")]
        public static extern short D2K_AI_SimuReadChannel(ushort wCardNumber, ushort wNumChans, ushort[] pwChans, IntPtr pwBuffer);
        [DllImport("D2K-Dask.dll")]
        public static extern short D2K_AI_SimuReadChannel(ushort wCardNumber, ushort wNumChans, IntPtr pwChans, IntPtr pwBuffer);
        [DllImport("D2K-Dask.dll")]
        public static extern short D2K_AI_ScanReadChannels(ushort wCardNumber, ushort wNumChans, ushort[] pwChans, ushort[] pwBuffer);
        [DllImport("D2K-Dask.dll")]
        public static extern short D2K_AI_ScanReadChannels(ushort wCardNumber, ushort wNumChans, ushort[] pwChans, IntPtr pwBuffer);
        [DllImport("D2K-Dask.dll")]
        public static extern short D2K_AI_ScanReadChannels(ushort wCardNumber, ushort wNumChans, IntPtr pwChans, IntPtr pwBuffer);
        [DllImport("D2K-Dask.dll")]
        ...
        [DllImport("D2K-Dask.dll")]
        public static extern short D2K_AI_ContVScale(ushort wCardNumber, ushort adRange, IntPtr readingArray, double[] voltageArray, int count);
        [DllImport("D2K-Dask.dll")]
        public static extern short D2K_AI_ContVScale(ushort wCardNumber, ushort adRange, IntPtr readingArray, IntPtr voltageArray, int count);
        [DllImport("D2K-Dask.dll")]
        ...
        [DllImport("D2K-Dask.dll")]
        public static extern short D2K_AI_ContBufferSetup(ushort wCardNumber, IntPtr pwBuffer, uint dwReadCount, out ushort BufferId);
        [DllImport("D2K-Dask.dll")]
        ...
        [DllImport("D2K-Dask.dll")]
        public static extern short D2K_AI_MuxScanSetup(ushort wCardNumber, ushort wNumChans, IntPtr pwChans, IntPtr pwAdRange_RefGnds);
        [DllImport("D2K-Dask.dll")]
        ...
        [DllImport("D2K-Dask.dll")]
        public static extern short D2K_AI_EventCallBack(ushort wCardNumber, short mode, ushort EventType, MulticastDelegate callbackAddr);
        [DllImport("D2K-Dask.dll")]
        ...
        [DllImport("D2K-Dask.dll")]
        public static extern short D2K_AO_ContBufferSetup(ushort wCardNumber, IntPtr pwBuffer, uint dwWriteCount, out ushort BufferId);
        [DllImport("D2K-Dask.dll")]
        ...
        [DllImport("D2K-Dask.dll")]
        public static extern short D2K_AO_ContBufferComposeAll(ushort wCardNumber, ushort group, uint dwUpdateCount, IntPtr ConBuffer, IntPtr pwBuffer, bool fifoload);
        [DllImport("D2K-Dask.dll")]
        ...
        [DllImport("D2K-Dask.dll")]
        public static extern short D2K_AO_ContBufferCompose(ushort wCardNumber, ushort group, ushort wChannel, uint dwUpdateCount, IntPtr ConBuffer, IntPtr pwBuffer, bool fifoload);
        [DllImport("D2K-Dask.dll")]
        public static extern short D2K_AO_EventCallBack(ushort wCardNumber, short mode, short EventType, MulticastDelegate callbackAddr);
        [DllImport("D2K-Dask.dll")]
