...
namespace Framework
{
    public class AdvCan
    {
        ...
        public static extern SafeWaitHandle CreateEvent(int lpEventAttributes, bool bManualReset, bool bInitialState, string lpName);

        [DllImport("kernel32.dll")]
        public static extern bool GetOverlappedResult(IntPtr hFile, IntPtr lpOverlapped, ref uint lpNumberOfBytesTransferred, bool bWait);
        ...
        [DllImport("kernel32.dll")]
        public static extern IntPtr CreateFile(string lpFileName, uint dwDesiredAccess, int dwShareMode, int lpSecurityAttributes, uint dwCreationDisposition, uint dwFlagsAndAttributes, int hTemplateFile);
        ...
        [DllImport("kernel32.dll")]
        public static extern bool WriteFile(IntPtr hDevice, IntPtr pbData, uint nNumberOfFramesToWrite, ref uint lpNumberOfFramesWritten, IntPtr lpOverlapped);

        [DllImport("kernel32.dll")]
        public static extern bool ReadFile(IntPtr hDevice, IntPtr pbData, uint nNumberOfFramesToRead, ref uint lpNumberOfFramesRead, IntPtr lpOverlapped);

        [DllImport("kernel32.dll")]
        public static extern bool SetCommMask(IntPtr hDevice, uint dwEvtMask);

        [DllImport("kernel32.dll")]
        public static extern bool GetCommMask(IntPtr hDevice, ref uint dwEvtMask);
