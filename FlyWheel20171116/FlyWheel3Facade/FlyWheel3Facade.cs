...
using System.Text;
using System.Data;
using Business.FlyWheel3Business;

namespace Facade.FlyWheel3Facade
{
    public class FlyWheel3Facade
    {
        public FlyWheel3Facade()
        {
        }
        ...
        {
            FlyWheel3Business business = new FlyWheel3Business();
