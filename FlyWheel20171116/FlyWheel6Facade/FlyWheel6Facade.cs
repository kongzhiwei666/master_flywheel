...
using System.Text;
using System.Data;
using Business.FlyWheel6Business;

namespace Facade.FlyWheel6Facade
{
    public class FlyWheel6Facade
    {
        public FlyWheel6Facade()
        {
        }
        ...
        {
            FlyWheel6Business business = new FlyWheel6Business();
