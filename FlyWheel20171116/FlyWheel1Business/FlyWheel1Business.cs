...
namespace Business.FlyWheel1Business
{
    public class FlyWheel1Business
    {
        ...
        public FlyWheel1Business()
        {
            try
            {
                ...
                //电机ID
                string AxisID = System.Configuration.ConfigurationSettings.AppSettings["Motor1AxisIDString"];
                string[] axisPara = AxisID.Split('=');
                axis_IDnumber = axisPara[1].Trim();
                Defs.Motor1ID = axis_IDnumber;
            }
            catch (Exception ex)
            {
            ...
            string experiment_memeber,string experiment_product)
        {
            ...
            if (state == "ON")
            {
              ...
              //  short ret1 = D2KDASK.D2K_AI_MuxScanSetup(0, 1, chans, ranges);
                ...
                while (true)
                {
                    D2KDASK.D2K_AI_MuxScanSetup(0, 1, chans, ranges);
                ...
                {
                    WriteDataToDatabaseWave("1", "7", MotorCur[i].ToString(), dttime[i].ToString(), experiment_name, experiment_memeber, experiment_product);
            ...
            string RotorRevRea, string datetime, string experiment_name, string experiment_memeber, string experiment_product, string real_deta_moment)
        {
            ...
            string sql = "insert into dbo.Motor11(MotorID, Scheme, SouceVol, SouceCut, RotorVol, RotorCut, RotorPow, ConstantMoment, ChangeMoment, RotorRevIde, RotorRevRea, DateTime, backup1,backup2,backup3,backup4)";
    ...
    string RotorPow, string RotorRevRea, string MeanTorque, string datetime, string ideal_torque, string experiment_name, string experiment_memeber, string experiment_product)
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor12(MotorID, Scheme, SouceVol, SouceCut, RotorVol, RotorCut, RotorPow, RotorRevRea, MeanTorque, datetime,backup1,backup2,backup3,backup4)";
        ...
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor16(MotorID, Scheme, RotorCut,datetime,backup1,backup2,backup3)";
        ...
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor13(MotorID, Scheme, SouceVol, SouceCut, RotorVol, RotorCut, RotorPow, RotorRevIde, RotorRevRea, datetime, backup1,backup2,backup3,backup4,backup5,backup6,backup7,backup8)";
    ...
    string RotorPow, string RotorRevRea, string MeanTorque, string datetime, string ideal_torque, string experiment_name, string experiment_memeber, string experiment_product, string Scheme4_torque)
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor14(MotorID, Scheme, SouceVol, SouceCut, RotorVol, RotorCut, RotorPow, RotorRevRea, MeanTorque, datetime,backup1,backup2,backup3,backup4,backup5)";
        ...
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor15(MotorID, Scheme, TimeConstant, datetime,backup1,backup2,backup3)";
