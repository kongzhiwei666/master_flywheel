...
using System.Text;
using System.Data;
using Business.FlyWheel8Business;

namespace Facade.FlyWheel8Facade
{
    public class FlyWheel8Facade
    {
        public FlyWheel8Facade()
        {
        }
        ...
        {
            FlyWheel8Business business = new FlyWheel8Business();
