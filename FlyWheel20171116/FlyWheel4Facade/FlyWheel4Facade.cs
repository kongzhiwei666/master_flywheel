...
using System.Text;
using System.Data;
using Business.FlyWheel4Business;

namespace Facade.FlyWheel4Facade
{
    public class FlyWheel4Facade
    {
        public FlyWheel4Facade()
        {
        }
        ...
        {
            FlyWheel4Business business = new FlyWheel4Business();
