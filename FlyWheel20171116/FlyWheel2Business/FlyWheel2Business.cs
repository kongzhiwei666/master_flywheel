...
namespace Business.FlyWheel2Business
{
    public class FlyWheel2Business
    {
        ...
        public FlyWheel2Business()
        {
            try
            {
                ...
                //电机ID
                string AxisID = System.Configuration.ConfigurationSettings.AppSettings["Motor2AxisIDString"];
                string[] axisPara = AxisID.Split('=');
                axis_IDnumber = axisPara[1].Trim();
                Defs.Motor2ID = axis_IDnumber;
            }
            catch (Exception ex)
            {
            ...
            string experiment_memeber, string experiment_product)
        {
            ...
            if (state == "ON")
            {
                ...
                {
                    WriteDataToDatabaseWave("2", "7", MotorCur[i].ToString(), dttime[i].ToString(), experiment_name, experiment_memeber, experiment_product);
                }
                #endregion
            ...
            string RotorRevRea, string datetime, string experiment_name, string experiment_memeber, string experiment_product, string real_deta_moment)
        {
            ...
            string sql = "insert into dbo.Motor21(MotorID, Scheme, SouceVol, SouceCut, RotorVol, RotorCut, RotorPow, ConstantMoment, ChangeMoment, RotorRevIde, RotorRevRea, DateTime, backup1,backup2,backup3,backup4)";
    ...
    string RotorPow, string RotorRevRea, string MeanTorque, string datetime, string ideal_torque, string experiment_name, string experiment_memeber, string experiment_product)
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor22(MotorID, Scheme, SouceVol, SouceCut, RotorVol, RotorCut, RotorPow, RotorRevRea, MeanTorque, datetime,backup1,backup2,backup3,backup4)";
        ...
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor26(MotorID, Scheme, RotorCut,datetime,backup1,backup2,backup3)";
        ...
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor23(MotorID, Scheme, SouceVol, SouceCut, RotorVol, RotorCut, RotorPow, RotorRevIde, RotorRevRea, datetime, backup1,backup2,backup3,backup4,backup5,backup6,backup7,backup8)";
    ...
    string RotorPow, string RotorRevRea, string MeanTorque, string datetime, string ideal_torque, string experiment_name, string experiment_memeber, string experiment_product, string Scheme4_torque)
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor24(MotorID, Scheme, SouceVol, SouceCut, RotorVol, RotorCut, RotorPow, RotorRevRea, MeanTorque, datetime,backup1,backup2,backup3,backup4,backup5)";
        ...
        {
            string sInfo = string.Empty;
            string sql = "insert into dbo.Motor25(MotorID, Scheme, TimeConstant, datetime,backup1,backup2,backup3)";
